...
<script>
        ...
        console.log("verifyotp?email="+v+"&oid="+oid+"&otp="+p+"&trans_email="+e);
        req.open("get", "verifyotp?email="+v+"&oid="+oid+"&otp="+p+"&trans_email="+e, true);
        req.send();            
        }
        function getResult(){
...
<div class="container-fluid">
  <div class="row content">
    ...
    <div class="col-sm-10">
      ...
      <div class="well">
        <h3>Order in Processing OID : <%=oid%></h3>
      ...
      <div class="well">
           <div class="container">
                  ...
                  <p>
                    ...
                    <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Transporter Details</button>
    ...
    <tbody>
      ...
      <!--<form class="form-inline" action="verifyotp">-->
                    ...
                    <input type="hidden"  id="email1" value="<%=email%>"/>
                        <div >
                          <label for="price">Order PickUp(Enter OTP)</label>
