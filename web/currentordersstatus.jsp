         ...
         transporter=rs1.getString(12);}else{
             transporter=rs1.getString(11);
              ...
              <tr>
                ...
                <td><%=transporter%></td>
                <%if(utype.equals("Customer")){%>
                <td><a href="orderinfo.jsp?oid=<%=oid%>"><button class="btn btn-primary">Click Here</button></a></td>
                <%}else{%>
                <td><a href="order_trans_info.jsp?oid=<%=oid%>"><button class="btn btn-primary">Click Here</button></a></td>
