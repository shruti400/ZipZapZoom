  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav left_col">
        ...
        <li class="active"><a href="aa_notification.jsp">Notifications</a></li>
  ...
  <div class="row content">
    <div class="sidenav col-sm-2  hidden-xs left_col  ">
      ...
      <ul class="nav nav-pills  nav-stacked ">
        ...
        <li class="list active"><a href="aa_notification.jsp"><i class="fa fa-bell-o" style="font-size:170%;color:white;"></i>Notifications</a></li>
        </ul><br>
    </div>
    <br>
    ...
    <div class="col-sm-10">
      ...
      <div class="well">
        ...
        <div> <%=i%>. <%=msg%> 
            <span>
                <%if(msg.substring(0,11).equals("A new order")){%>
     %>
        <a href="aa_query.jsp "> ...know more</a>
    <%}else{%>
    
    
    <a href="transporter_verify.jsp"> ...know more</a>
        <%}%>
            </span>
    </div>
        <%
