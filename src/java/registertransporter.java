 ...
 * @author SOM
 */
public class registertransporter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String verify=(String)session.getAttribute("checked");
        if(verify.equals("yes")){
            try {
               ...
               PreparedStatement ps=con.prepareStatement("insert into transporterMain(emailaddress,pancardno,insurancepolicyno,accountno) values(?,?,?,?)");
                ps.setString(1,email);
                ps.setString(2,pancardno);
                ps.setString(3,ipn);
                ps.setString(4,ban);
